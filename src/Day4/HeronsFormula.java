package Day4;// Many years ago when Paul went to school, he did not like the Heron's formula to calculate the area of a triangle, mainly because he considered it very complex. He decided to help all the other students in his school by writing and distributing a program, which could calculate the area of a triangle by using the lengths of its three sides.
